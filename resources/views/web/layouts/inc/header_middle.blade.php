    ...
    <div class="{{ $PageView['container'] }}">
        <div class="nav_block">
            <a class="navbar-brand" href="index.html">
                <img class="logo_light" src="{{ defWebAssets('images/logo_light.png') }}" alt="logo" />
                <img class="logo_dark" src="{{ defWebAssets('images/logo_dark.png') }}" alt="logo" />
            </a>
                        ...
                        <div class="cart_box dropdown-menu dropdown-menu-right">
                            <ul class="cart_list">
                                <li>
                                    ...
                                    <a href="#"><img src="{{ defWebAssets('images/cart_thamb1.jpg') }}" alt="cart_thumb1">Variable product 001</a>
                                    <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">$</span></span>78.00</span>
                                </li>
                                <li>
                                    <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                    <a href="#"><img src="{{ defWebAssets('images/cart_thamb2.jpg') }}" alt="cart_thumb2">Ornare sed consequat</a>
