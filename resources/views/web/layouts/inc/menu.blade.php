                                    ...
                                    <ul class="mega-menu d-lg-flex">
                                        ...
                                        <li class="mega-menu-col col-lg-5">
                                            <div class="header-banner2">
                                                <img src="{{ defWebAssets('images/menu_banner7.jpg') }}" alt="menu_banner1">
                                            ...
                                            <div class="header-banner2">
                                                <img src="{{ defWebAssets('images/menu_banner7.jpg') }}" alt="menu_banner2">
                                                <div class="banne_info">
                                                    <h6>15% Off</h6>
                                                    <h4>Top Laptops</h4>
                                                    <a href="#">Shop now</a>
                            ...
                            <li class="dropdown dropdown-mega-menu">
                                ...
                                <div class="dropdown-menu">
                                    <ul class="mega-menu d-lg-flex">
                                        ...
                                        <li class="mega-menu-col col-lg-5">
                                            <div class="header-banner2">
                                                <a href="#"><img src="{{ defWebAssets('images/menu_banner7.jpg') }}" alt="menu_banner"></a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
